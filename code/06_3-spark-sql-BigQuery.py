...
spark = SparkSession.builder.appName(  # USING spark-submit; see config_clouds
    "test"
).getOrCreate()
...
spark.conf.set("temporaryGcsBucket", "dataproc-temp-sa-east1-957627529008-njjq8bhh")

# Write the contents of df_result to a BigQuery table
